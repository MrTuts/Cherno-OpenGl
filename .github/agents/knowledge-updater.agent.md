...
3. Read the current `KNOWLEDGE.md` in full.
...
5. Edit `KNOWLEDGE.md` with the minimal set of additions or corrections required.
...
- ONLY document things a reader would need to understand *why* the code is structured the way it is, or *what* an API/concept does.
